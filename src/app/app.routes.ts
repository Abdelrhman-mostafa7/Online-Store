    ...
    
    {
        ...
        children: [
            ...
            },
            {
                path: 'Forgetpassword',
                loadComponent: () =>
                    import('./pages/forgetpassword/forgetpassword/forgetpassword.component').then((c) => c.ForgetpasswordComponent),
...

    {
        ...
        children: [
            ...
            },
            {
                path: 'categories',
                loadComponent: () =>
                    import('./pages/categaries/categaries.component').then((c) => c.CategariesComponent),
                title: 'Categories',
            },

            {
                ...
                title: 'Checkout',
                data: { renderMode: 'NoPrerender' } // 🚀 تعطيل التصيير المسبق
            },
            {
                path: 'products',
                loadComponent: () =>
            ...
            },
            {
                path: 'Wishlist',
                loadComponent: () =>
                    import('./pages/wishlist/wishlist/wishlist.component').then((c) => c.WishlistComponent),
                title: 'Wishlist',
            },
            {
                path: 'allorders',
                loadComponent: () =>
                    import('./pages/allorders/allorders/allorders.component').then((c) => c.AllordersComponent),
                title: 'allorders',
            },
            {
                path: 'details/:id',
